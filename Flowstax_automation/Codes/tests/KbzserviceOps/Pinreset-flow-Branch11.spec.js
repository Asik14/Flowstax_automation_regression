...
(async () => {
  ...
  try {
    console.log('✅ Starting KBZ3 Test...');
    ...
    await base.page.evaluate(() => {
      const element = Array.from(document.querySelectorAll('flt-semantics')).find(el => el.textContent.trim() === 'PIN Reset Request');
      if (element) {
    ...
    await base.NextButton();
    console.log('✅ KBZ3 Test Completed Successfully!');
